...
def test_linear_blending(
    ...
    for i in range(n_timesteps):
        plot_precip_field(R_NWP[i, :, :])
        plt.title("Test NWP data at timestep {}".format(i + 1))
        plt.savefig("./images/test/test_NWP_{}.png".format(i + 1))
        plt.close()
    ...
    # Plot input field
    plot_precip_field(R_input)
    plt.title("Test input data")
    plt.savefig("./images/test/test_input.png")
    plt.close()
    ...
    # Plot blended field
    for i in range(n_timesteps):
        plot_precip_field(R_blended[i, :, :])
        plt.title("Test blended data at timestep {}".format(i + 1))
        plt.savefig("./images/test/test_blended_{}.png".format(i + 1))
        plt.close()
...
for args in linear_arg_values[:1]:
    (
        timestep,
        start_blending,
        end_blending,
